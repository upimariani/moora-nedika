									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><a href="<?= base_url('Admin/cAnalisis/detail_analisis/' . $value->tgl_proses . '/' . $value->periode) ?>" class="btn btn-warning">Detail Analisis Karyawan</a></td>
												<!-- <td><a href="<?= base_url('Admin/cAnalisis/hapus/' . $value->year . '/' . $value->periode) ?>" class="btn btn-danger">Hapus</a></td> -->
											</tr>
										<?php
										}
										?>
